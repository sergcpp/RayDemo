...
void WriteTGA(const Ray::color_rgba_t *data, int w, int h, int bpp, bool flip_vertical, const char *name);
void WritePNG(const Ray::color_rgba_t *data, int w, int h, int bpp, bool flip_vertical, const char *name);
