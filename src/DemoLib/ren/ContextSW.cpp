...
void Ren::Context::Init(const int w, const int h) {
    w_ = w;
    h_ = h;
...
Ren::ProgramRef Ren::Context::LoadProgramSW(const char *name, void *vs_shader, void *fs_shader, const int num_fvars,
