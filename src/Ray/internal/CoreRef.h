...
void JointNLMFilter(const color_rgba_t input[], const rect_t &rect, int input_stride, float alpha, float damping,
                    const color_rgba_t variance[], const color_rgba_t feature1[], float feature1_weight,
                    const color_rgba_t feature2[], float feature2_weight, const rect_t &output_rect, int output_stride,
                    color_rgba_t output[]);
