...
void comp_main()
{
    do
    {
        ...
        g_temp_feature0[_410][_413] = spvPackUnorm4x8(g_feature0_img.SampleLevel(_g_feature0_img_sampler, _391, 0.0f, int2(-4, -4)));
        g_temp_feature0[_410][_445] = spvPackUnorm4x8(g_feature0_img.SampleLevel(_g_feature0_img_sampler, _391, 0.0f, int2(4, -4)));
        g_temp_feature0[_469][_413] = spvPackUnorm4x8(g_feature0_img.SampleLevel(_g_feature0_img_sampler, _391, 0.0f, int2(-4, 4)));
        g_temp_feature0[_469][_445] = spvPackUnorm4x8(g_feature0_img.SampleLevel(_g_feature0_img_sampler, _391, 0.0f, int2(4, 4)));
        AllMemoryBarrier();
            ...
            for (; l <= 3; l++)
            {
                ...
                for (; q <= 1; q++)
                {
                    ...
                    for (int p = -1; p <= 1; )
                    {
                        ...
                        _distance += (mad(_876, _876, -((_829 + min(_829, _869)) * _364_g_params.alpha)) / (9.9999997473787516355514526367188e-05f.xxxx + ((_829 + _869) * (_364_g_params.damping * _364_g_params.damping))));
                        p++;
                        continue;
                    }
                }
                ...
                int _944 = _932 + k;
                int _949 = _935 + l;
                float4 _958 = spvUnpackUnorm4x8(g_temp_feature0[_932][_935]) - spvUnpackUnorm4x8(g_temp_feature0[_944][_949]);
                float4 _963 = (_958 * _364_g_params.feature0_weight) * _958;
                float _985 = min(exp(-max(0.0f, 2.25f * (((_distance.x + _distance.y) + _distance.z) + _distance.w))), exp(-max(0.0f, 0.25f * (((_963.x + _963.y) + _963.z) + _963.w))));
